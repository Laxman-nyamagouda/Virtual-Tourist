...
class VirtualTravelMapViewController: UIViewController, MKMapViewDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.destination is VirtualPhotoAlbumViewController {
            guard let pin = sender as? Pin else {
                return
            }
            let controller = segue.destination as! VirtualPhotoAlbumViewController
            controller.pin = pin
        }
    }
...
extension VirtualTravelMapViewController {
